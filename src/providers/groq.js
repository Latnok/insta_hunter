...
async function groqRequest(config, form) {
...
function runFfmpeg(input, output, { spawnImpl = spawn, timeoutMs = 180_000 } = {}) {
...
async function downloadAndTranscribe(config, mediaUrl, dependencies = {}) {
  ...
  try {
    ...
    await (dependencies.downloadMedia || downloadMediaToFile)(mediaUrl, input);
    await (dependencies.runFfmpeg || runFfmpeg)(input, output);
    ...
    return await (dependencies.groqRequest || groqRequest)(config, form);
  } finally {
...
export async function transcribeWithGroq(config, mediaUrl, dependencies = {}) {
  ...
  try { return await (dependencies.groqRequest || groqRequest)(config, form); }
  catch (error) {
