const dictionaries = {
  ru: {
    ...
    'automation.controls': 'Управление автоматизацией', 'automation.discovery': 'Автопоиск', 'automation.processing': 'Автообработка', 'automation.on': 'Вкл', 'automation.off': 'Выкл',
    'automation.discoveryHelp': 'Фоновый поиск кандидатов', 'automation.processingHelp': 'Автоматический анализ новых кандидатов',
  ...
  en: {
    ...
    'automation.controls': 'Automation controls', 'automation.discovery': 'Auto-search', 'automation.processing': 'Auto-processing', 'automation.on': 'On', 'automation.off': 'Off',
    'automation.discoveryHelp': 'Background candidate search', 'automation.processingHelp': 'Automatically analyze new candidates',
