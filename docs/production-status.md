...
- Latest verification: 32/32 integration tests and 53/53 default tests pass without live API calls; syntax checks cover 57 JavaScript files and 14 EJS templates.
